    ...
    <div class="container single-post" bis_skin_checked="1">
        <div class="breadcrumb" bis_skin_checked="1">
           <ul class="breadcrumb__list">
              ...
              <li><a href="https://www.tncstore.vn/doanh-thu-sut-giam-manh-da-den-luc-amd-choi-tat-tay-voi-cpu-ryzen-7000.html"><?php echo $news_detail->getTitle(); ?></a></li>
           </ul>
        </div>

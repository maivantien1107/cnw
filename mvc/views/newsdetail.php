    ...
    <div class="container single-post" bis_skin_checked="1">
        <div class="breadcrumb" bis_skin_checked="1">
           <ul class="breadcrumb__list">
              ...
              <li><a href="<?php echo "/cnw-1/newsdetail/".$news_detail->getNews_id()."/".$path;?>"><?php echo $news_detail->getTitle(); ?></a></li>
           </ul>
        </div>
        <div class="content" bis_skin_checked="1">
           ...
           <div class="post_content" bis_skin_checked="1">
              ...
              <p dir="ltr" style="text-align: center; line-height: 1.38; margin-top: 12pt; margin-bottom: 12pt;"><img src="../../public/img/news/<?php echo $news_detail->getNews_id();?>_image4.webp" style="width: 730px;"><span style="font-size: 18px; color: rgb(0, 0, 0); background-color: transparent; font-weight: 400; font-style: normal; font-variant: normal; text-decoration: none; vertical-align: baseline; white-space: pre-wrap;"><font face="Chakra Petch"><br></font></span></p>
              ...
              <p dir="ltr" style="text-align: center; line-height: 1.38; margin-top: 12pt; margin-bottom: 12pt;"><img src="../../public/img/news/<?php echo $news_detail->getNews_id();?>_image5.webp" style="width: 730px;"><span style="font-size: 18px; color: rgb(0, 0, 0); background-color: transparent; font-weight: 400; font-style: normal; font-variant: normal; text-decoration: none; vertical-align: baseline; white-space: pre-wrap;"><font face="Chakra Petch"><br></font></span></p>
              ...
              <p dir="ltr" style="line-height: 1.38; margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 18px; color: rgb(0, 0, 0); background-color: transparent; font-weight: 400; font-style: normal; font-variant: normal; text-decoration: none; vertical-align: baseline; white-space: pre-wrap;"><font face="Chakra Petch"><?php echo $news_detail->getDes7(); ?></font></span></p>
            ...
            <?php 
             ...
             foreach($news_top as $news_post){
               ...
               <div class="post" bis_skin_checked="1">
                 <div class="thumb" bis_skin_checked="1"><a href="<?php echo "/cnw-1/newsdetail/".$news_post->getNews_id()."/".$path_post ?>"><img src="../../public/img/news/<?php echo $news_post->getNews_id();?>_image1.webp" width="350" height="199"></a></div>
